...
const Cart: React.FC = () => {
  const { cartItems, removeFromCart, updateQuantity, clearCart, totalItems, totalPrice, loading } = useCart();
  const { user } = useAuth();
        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="bg-gradient-to-r from-[#8DA63F] via-[#707e22] to-[#666e21] p-3 rounded-full">
        ...
        {cartItems.length === 0 ? (
          ...
          >
            ...
            <Link to="/marketplace/buy-sell" className="inline-block">
              <Button className="bg-gradient-to-r from-[#8DA63F] via-[#707e22] to-[#666e21] text-white px-8 py-3 rounded-full">
                Continue Shopping
              </Button>
            </Link>
          </motion.div>
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button className="flex-1 bg-gradient-to-r from-[#8DA63F] via-[#707e22] to-[#666e21] text-white rounded-full py-3 text-lg font-semibold">
                  Proceed to Checkout
                </Button>
              </div>
            </motion.div>
