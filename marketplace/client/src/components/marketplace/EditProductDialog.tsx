                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      <option value="pulses_legumes">🫘 Pulses & Legumes</option>
                      <option value="oilseeds">🌻 Oilseeds</option>
                      <option value="fiber_crops">🧶 Fiber Crops</option>
                      <option value="sugar_crops">🍯 Sugar Crops</option>
                      <option value="vegetables">🥬 Vegetables</option>
                      <option value="fruits">🍎 Fruits</option>
                      <option value="beverage_crops">☕ Beverage Crops</option>
                      <option value="cultivated_fungi">🍄 Cultivated Fungi</option>
                      <option value="aquaculture">🐟 Aquaculture</option>
                      <option value="farmed_animals">🐄 Farmed Animals</option>
