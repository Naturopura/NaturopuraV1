    ...
    <AdminLayout title="Farmer Management" subtitle="Manage and monitor registered farmers">
      <div className="p-3 sm:p-4 lg:p-6 xl:p-8 space-y-4 sm:space-y-6 lg:space-y-8 max-w-7xl mx-auto">
        ...
        {isLoading ? (
          ...
          // Farmer Table
          <div className="overflow-hidden bg-white rounded-2xl shadow-xl border border-gray-100/50 backdrop-blur-sm">
                    ...
                    >
                      <TableCell className="py-3 sm:py-4 px-3 sm:px-6">
                        <div className="flex items-center space-x-2 sm:space-x-3">
                          <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-emerald-400 to-teal-500 rounded-full flex items-center justify-center text-white font-semibold text-xs sm:text-sm shadow-lg">
