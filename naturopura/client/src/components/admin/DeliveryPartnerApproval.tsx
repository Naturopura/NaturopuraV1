              ...
              <div className="overflow-x-auto rounded-xl shadow">
                <table className="w-full table-auto border-collapse">
                  <thead className="sticky top-0 z-10 bg-emerald-100/80">
                    <tr>
                      <th className="px-5 py-3 text-left text-xs font-bold text-emerald-800 uppercase tracking-wider rounded-tl-xl">
                        Name
                      </th>
                      ...
                      <th className="px-5 py-3 text-left text-xs font-bold text-emerald-800 uppercase tracking-wider rounded-tr-xl">
                        Actions
                      </th>
                    </tr>
                  </thead>
                      ...
                      >
                        ...
                        <td className="px-5 py-3 space-x-2">
                          <Button
                            size="sm"
                            variant="outline"
                            disabled={dp.deliveryPartnerApprovalStatus === 'approved' || updatingId === dp.id}
                            onClick={() => updateApprovalStatus(dp.id, 'approved')}
                            className="flex items-center gap-1 border-emerald-300 hover:bg-emerald-100 transition"
                          >
                          ...
                          <Button
                            size="sm"
                            variant="destructive"
                            disabled={dp.deliveryPartnerApprovalStatus === 'rejected' || updatingId === dp.id}
                            onClick={() => updateApprovalStatus(dp.id, 'rejected')}
                            className="flex items-center gap-1 border-red-300 hover:bg-red-100 transition"
                          >
