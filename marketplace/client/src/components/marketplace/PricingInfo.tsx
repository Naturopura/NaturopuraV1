...
import { Leaf, PackageSearch, TrendingUp, TrendingDown, DollarSign, Users, Package} from "lucide-react";
...
const PricingInfo: React.FC = () => {
  ...
  return (
      <div className="p-4 md:p-6 space-y-6 md:space-y-8 max-w-7xl mx-auto">
        {/* Hero Section */}
        <motion.div 
          className="bg-gradient-to-r from-[#8DA63F] via-[#b0c632] to-[#939e31] rounded-3xl p-6 md:p-8 lg:p-12 text-white relative overflow-hidden"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
            ...
            <Card className="hidden lg:block bg-white/70 backdrop-blur-lg border-0 shadow-xl overflow-hidden">
              <CardHeader className="bg-gradient-to-r from-gray-50 to-gray-100 border-b-0">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="p-2 bg-gradient-to-r from-[#8DA63F] via-[#b0c632] to-[#beca55] rounded-xl">
