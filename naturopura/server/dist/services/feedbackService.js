...
const feedbackDao = __importStar(require("../dao/feedbackDao"));
const createFeedback = (data) => __awaiter(void 0, void 0, void 0, function* () {
    return yield feedbackDao.createFeedbackRecord(data);
});
exports.createFeedback = createFeedback;
const getAllFeedbacks = (options) => __awaiter(void 0, void 0, void 0, function* () {
    return yield feedbackDao.findAllFeedbacks(options);
});
