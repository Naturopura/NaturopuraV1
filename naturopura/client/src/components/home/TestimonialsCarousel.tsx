...
const testimonials = [
  {
    ...
    location: "Punjab",
    image: "https://media.licdn.com/dms/image/v2/D4E03AQEUGYWM3-BLJg/profile-displayphoto-shrink_100_100/profile-displayphoto-shrink_100_100/0/1671088385192?e=1756339200&v=beta&t=FlG_wt8mI6KFRqHGAbBKMkSTcfYTl5YK5SaT-J4R2Bg",
  ...
  },
  {
    ...
    image: "https://media.licdn.com/dms/image/v2/D5603AQErK0KoExcJcg/profile-displayphoto-shrink_100_100/profile-displayphoto-shrink_100_100/0/1728285518633?e=1756339200&v=beta&t=2K8x_VebFluIi6R0h3GlnRR2Y4LXP85yZpG6OVTA39A",
  ...
  },
  {
    ...
    location: "Gujarat",
    image: "https://media.licdn.com/dms/image/v2/D5603AQEsHwmT6zL6Ag/profile-displayphoto-shrink_400_400/profile-displayphoto-shrink_400_400/0/1725631931046?e=1756339200&v=beta&t=iM9YGm1ASdqvT1jIsonYhAGP90HLsYN6Mq5KzpYz0Z4", 
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div>
              ...
              <p className="text-blue-600 font-medium">{testimonials[currentIndex].crop}</p>
        ...
        {testimonials.map((_, index) => (
          <button
            ...
            className={`w-3 h-3 rounded-full transition-all duration-300 ${
              index === currentIndex ? 'bg-blue-500 scale-125' : 'bg-blue-200'
            }`}
          />
        ))}
      </div>
