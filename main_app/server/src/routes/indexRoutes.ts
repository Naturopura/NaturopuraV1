...
import equipmentRequestRoutes from './equipmentRequestRoutes';
import equipmentSearchRoutes from './equipmentSearchRoutes';
...
import adminEquipmentRequestRoutes from './adminEquipmentRequestRoutes';
import weatherAlertRoutes from './weatherAlertRoutes';
...
router.use('/equipment-search', equipmentSearchRoutes);
router.use('/admin', adminEquipmentRequestRoutes);
...
router.use('/weather-alerts', weatherAlertRoutes);
