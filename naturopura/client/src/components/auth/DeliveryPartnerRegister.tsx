...
import { User, Mail, Lock, Phone, Truck, CheckCircle, AlertCircle } from 'lucide-react';
    ...
    >
      ...
      <div className="max-w-md w-full relative z-10">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-3xl mb-6 shadow-2xl shadow-emerald-500/30 transform hover:scale-105 transition-transform duration-300">
            <Truck className="w-10 h-10 text-white" />
          </div>
          <h1 className="text-4xl font-bold text-white mb-3 drop-shadow-lg">Join Our Team</h1>
          <p className="text-blue-100 text-lg drop-shadow-md">Become a delivery partner and start earning</p>
        </div>

        <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl shadow-blue-500/20 p-8 border border-white/20">
          <h2 className="text-2xl font-bold text-gray-900 mb-6 text-center">Delivery Partner Registration</h2>
            ...
            <div className="space-y-1">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  required
                  className="w-full pl-12 pr-4 py-4 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-200 bg-gray-50/80 hover:bg-white focus:bg-white text-gray-900 placeholder-gray-500 shadow-sm hover:shadow-md focus:shadow-lg"
