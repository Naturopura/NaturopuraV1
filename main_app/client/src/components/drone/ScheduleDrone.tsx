      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-cyan-50 p-6">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-naturopura-gradient text-white rounded-2xl shadow-xl mb-6">
              <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8" />
              </svg>
            </div>
            <h2 className="text-4xl font-bold text-naturopura-gradient mb-2">
              Mission Planning
            </h2>
          ...
          <div className="bg-white/80 backdrop-blur-sm border border-blue-200/50 rounded-2xl shadow-xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <label htmlFor="date" className="flex items-center space-x-2 naturopura-text font-semibold">
              ...
              {/* Field Name */}
              <div className="space-y-2">
                <label htmlFor="fieldName" className="flex items-center space-x-2 naturopura-text font-semibold">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {/* Provider Selection */}
              <div className="space-y-2">
                <label htmlFor="provider" className="flex items-center space-x-2 naturopura-text font-semibold">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <select
                  ...
                  className="w-full bg-gradient-to-r from-blue-50/50 to-cyan-50/30 border border-[#636d1e] rounded-xl px-4 py-3 text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-400/50 focus:border-transparent transition-all duration-300 shadow-sm"
                >
              ...
              {/* Location Section */}
              <div className="space-y-2">
                <label className="flex items-center space-x-2 naturopura-text font-semibold">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {currentLocation ? (
                  ...
                  <button
                    ...
                    className="w-full group relative px-6 py-4 bg-naturopura-gradient text-white font-semibold rounded-xl shadow-lg hover:shadow-blue-500/25 transition-all duration-300 transform hover:scale-105 disabled:transform-none disabled:cursor-not-allowed"
                  >
              ...
              <button
                type="submit"
                className="w-full group relative px-8 py-4 bg-naturopura-gradient text-white font-bold rounded-xl shadow-lg hover:shadow-green-500/25 transition-all duration-300 transform hover:scale-105 mt-8"
              >
                <span className="flex items-center justify-center space-x-3">
