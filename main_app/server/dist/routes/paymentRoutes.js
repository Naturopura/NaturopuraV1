...
router.get('/user/purchases', auth_1.authenticateToken, paymentController_1.getUserPurchases);
// Razorpay routes
router.post('/razorpay/order', auth_1.authenticateToken, paymentController_1.createRazorpayPayment);
router.post('/razorpay/verify', auth_1.authenticateToken, paymentController_1.verifyRazorpayPayment);
