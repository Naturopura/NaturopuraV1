...
exports.updateShippingAddress = exports.getShippingAddress = exports.deleteAddress = exports.updateAddress = exports.addAddress = exports.getUserAddresses = exports.updateUserProfile = exports.getFarmers = exports.checkPhoneVerification = exports.validateToken = exports.loginUser = exports.registerUser = void 0;
...
const updateAddress = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const addressIndex = (_b = user.addresses) === null || _b === void 0 ? void 0 : _b.findIndex(addr => addr._id === addressId);
        if (addressIndex === -1) {
            res.status(statusCode_1.default.NOT_FOUND).json({
                success: false,
        ...
        if (isDefault) {
            // Set all other addresses to not default
            user.addresses = ((_c = user.addresses) === null || _c === void 0 ? void 0 : _c.map(addr => (Object.assign(Object.assign({}, addr), { isDefault: addr._id === addressId })))) || [];
        }
