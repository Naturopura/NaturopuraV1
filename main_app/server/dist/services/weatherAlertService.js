...
class WeatherAlertService {
     ...
     */
    static analyzeWeather(weatherData) {
        const alerts = [];
        // Temperature alerts
     ...
     */
    static sendLocationBasedAlerts(latitude_1, longitude_1, weatherData_1) {
        return __awaiter(this, arguments, void 0, function* (latitude, longitude, weatherData, radiusKm = 50) {
            try {
                ...
                for (const farmer of farmers) {
                    try {
                        yield (0, smsService_1.sendSingleSMS)(farmer.phoneNumber, message);
                        successCount++;
     ...
     */
    static sendUserAlert(userId, weatherData) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const user = yield User_1.default.findById(userId).select('phoneNumber name role');
                ...
                yield (0, smsService_1.sendSingleSMS)(user.phoneNumber, message);
