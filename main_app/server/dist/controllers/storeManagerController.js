...
exports.getDashboardStats = exports.addExportImport = exports.addVehicle = exports.updateShippingDetails = exports.updateShippingStatus = exports.updateArrivalStatus = exports.updateProductStatus = exports.addProduct = void 0;
...
const updateArrivalStatus = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const errors = (0, express_validator_1.validationResult)(req);
    if (!errors.isEmpty()) {
        res.status(400).json({ success: false, errors: errors.array() });
        return;
    ...
    try {
        const updated = yield storeManagerService.updateArrivalStatus(req.params.id, req.body.arrival_status, req.user._id);
        if (!updated) {
            res.status(404).json({ success: false, message: "Product not found" });
            return;
        }
...
const updateShippingStatus = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const updated = yield storeManagerService.updateShippingStatus(req.params.id, req.body.shipping_status, req.user._id);
        if (!updated) {
            res.status(404).json({ success: false, message: "Product not found" });
            return;
        }
...
const updateShippingDetails = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    if (!req.user) {
        res.status(401).json({ success: false, message: "Unauthorized" });
        return;
    }
    try {
        ...
        const updated = yield storeManagerService.updateShippingDetails(req.params.id, { vehicle_number, origin, destination }, req.user._id);
        if (!updated) {
            res.status(404).json({ success: false, message: "Product not found" });
            return;
        }
