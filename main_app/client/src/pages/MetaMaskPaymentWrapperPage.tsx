...
const MetaMaskPaymentWrapperPage = () => {
  ...
  const handleAddressSelect = async (selectedAddress: Address) => {
    ...
    if (selectedPaymentMethod === 'razorpay') {
      ...
      try {
        ...
        navigate('/farmer/marketplace/razorpay-payment', { state: { product: fetchedProduct, address: completeAddress, totalAmount } });
      } catch (error) {
  ...
  return (
    <FarmerLayout title="Checkout Process" subtitle="Complete your purchase in simple steps">
