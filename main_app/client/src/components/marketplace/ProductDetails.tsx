...
const ProductDetail: React.FC<ProductDetailProps> = ({
  productId, onClose,  currentUserId
}) => {
  const { user } = useAuth();
  ...
  }, [product, cartQuantity, navigate, onClose]);
  ...
  }, [productId, fetchProductDetails]); // Added fetchProductDetails to dependency array
  ...
  // Placeholder functions - you'll need to implement their actual logic
  const getFarmerName = () => {
  ...
  const renderBuyButton = () => {
    ...
    return (
      <Button
        className="w-full bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white rounded-full py-3 font-semibold transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-[1.02]"
                            ...
                            <div className="space-y-3">
                              ...
                              <div className="flex items-center gap-3">
                                <Button
                                  ...
                                  className="rounded-full h-10 w-10 p-0 border-emerald-200 hover:bg-emerald-50"
                                >
                                  -
                                </Button>
                                <span className="text-lg font-semibold min-w-[3rem] text-center bg-emerald-50 px-3 py-1 rounded-lg">{cartQuantity}</span>
                                <Button
                                  variant="outline"
                                  size="sm"
                          ...
                          <div className="flex flex-col gap-3 pt-4">
                            {!isOwner && product.quantity > 0 && !isInCart && (
                              <Button
                                ...
                                variant="outline"
                                className="w-full border-emerald-200 text-emerald-700 hover:bg-emerald-50 rounded-full py-3 font-semibold transition-all duration-200"
                              >
                                <ShoppingCart className="h-4 w-4 mr-2" />
