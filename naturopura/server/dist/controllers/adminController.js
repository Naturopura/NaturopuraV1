...
exports.updateStoreManagerApproval = exports.getStoreManagers = exports.getDeliveryPartnerPurchases = exports.getDashboardStats = exports.getFarmers = exports.updateDeliveryPartnerApproval = exports.getDeliveryPartners = exports.getAdminPurchases = void 0;
...
const updateDeliveryPartnerApproval = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        console.error('Error updating delivery partner approval:', error);
        res.status(statusCode_1.default.INTERNAL_SERVER_ERROR).json({
            success: false,
...
const getDeliveryPartnerPurchases = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        console.error('Error fetching delivery partner purchases:', error);
        res.status(statusCode_1.default.INTERNAL_SERVER_ERROR).json({
            success: false,
