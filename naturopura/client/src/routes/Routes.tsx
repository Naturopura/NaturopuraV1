...
// import MetaMaskPaymentPage from "../pages/MetaMaskPaymentPage";

const FinancialServices = () => <div>Financial Services</div>; // Placeholder component
...
import BuySellFarmer from "../components/marketplace/BuySellFarmer";
import PricingInfo from "../components/marketplace/PricingInfo";
import Logistics from "../components/marketplace/Logistics";
...
import FeedbackForm from "../feedback/FeedbackCard";
  ...
  return (
    <ErrorBoundary>
      <Routes>
        ...
        <Route path="/marketplace/logistics/:productId" element={<Logistics />} />
        <Route path="/admin/logistics/:productId" element={<AdminLogistics />} />
      ...
      <Route
        path="/farmer/marketplace/buy-sell"
        element={
          <PrivateRoute allowedRoles={["farmer"]}>
            <BuySellFarmer />
          </PrivateRoute>
      ...
      />
        ...
        />
        <Route
          path="/farmer/marketplace/prices"
          element={
            <PrivateRoute allowedRoles={["farmer"]}>
              <PricingInfo />
            </PrivateRoute>
        ...
        />
        {/* This is the route that will receive scanned product ID */}
        <Route
          path="/farmer/marketplace/logistics/:productId"
          element={
            <PrivateRoute allowedRoles={["farmer"]}>
              <Logistics />
            </PrivateRoute>
      ...
      />
      <Route
        path="/farmer/marketplace/metamask-payment"
        element={
          <PrivateRoute allowedRoles={["farmer"]}>
      ...
      />
      {/* No dedicated scanner route here anymore. ProductScanner is now a modal */}
    </Routes>
    </ErrorBoundary>
  );
};
